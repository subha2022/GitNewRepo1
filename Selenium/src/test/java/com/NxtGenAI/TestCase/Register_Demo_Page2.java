...
public class Register_Demo_Page2 
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		System.out.println(verificationNum);*/
			...
			//Column for actual successful message
			Cell cellMsg = r.createCell(24);
			
			//Column for Transaction Id  
			Cell cellTransactionId=r.createCell(25);
			...
			if(status)
			{
				cellMsg.setCellValue(actRegMsg);
				cellTransactionId.setCellValue(trnNum);
